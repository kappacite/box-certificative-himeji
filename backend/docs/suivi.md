...
| [Algorithmes d'optimisation](file:///home/robyn/Documents/Programmation/box-certificative-himeji/backend/docs/part_algorithms.md) | 🟢 Complet | Distance de Haversine exacte, Plus Proche Voisin ($O(N^2)$) et affinage 2-opt. |
